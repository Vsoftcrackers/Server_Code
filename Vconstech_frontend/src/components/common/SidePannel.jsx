...
const handleItemClick = (index, path, hasSubmenu) => {
  ...
  return (
    <>
      ...
      <div className="fixed top-20 left-0 md:w-68 w-16 hover:w-64 border-r border-gray-300 bg-white h-[calc(100vh-5rem)] overflow-hidden overflow-x-hidden transition-all duration-300 z-50 group">
